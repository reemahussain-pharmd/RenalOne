"""AI Renal Report Generator Page — RenalOne."""
import sys
...
def render():
    ...
    with left_col:
        ...
        institution  = st.text_input("Institution", value="RenalOne Clinic")
...
def _generate_report(patient_name, provider, institution, risk_data, med_data, econ_data,
    ...
    try:
        ...
        fname = f"RenalOne_Report_{datetime.now().strftime('%Y%m%d_%H%M')}.pdf"
        st.download_button(
...
def _render_preview(risk_data, med_data, econ_data, adhr_data=None, show_header=True):
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;">
                <div>
                    <div style="font-size:1.2rem;font-weight:800;color:white;margin-bottom:3px;">
                        RenalOne — Clinical Intelligence Report
                    </div>
    ...
    preview_html += """
        <div style="background:#F8FAFC;border-radius:8px;padding:0.8rem;
            ...
            This report is generated by RenalOne for educational and decision-support purposes only.
