"""
AI Renal Report Generator — RenalOne
...
def _header_table(patient_name: str, report_date: str, report_id: str) -> Table:
    data = [[
        Paragraph(f"<font color='white' size=18><b>RenalOne</b></font>", ParagraphStyle("h", alignment=TA_LEFT, fontName="Helvetica-Bold", fontSize=18)),
...
def generate_report(report_data: dict) -> bytes:
    ...
    story.append(Spacer(1, 0.2*cm))
    disclaimer = (
        "⚕️ CLINICAL DISCLAIMER: This report is generated by RenalOne AI Platform for clinical decision support only. "
        ...
        "RenalOne | Version 1.0 | Generated: " + report_date
    )
...
def _fallback_text_report(data: dict) -> bytes:
    ...
    lines = [
        "=" * 60,
        "RenalOne — AI RENAL INTELLIGENCE REPORT",
        "=" * 60,
    ...
    lines.append("Generated by RenalOne AI Platform.")
